 ...
 * - Associative on multiplication: for all for all `x`, `y` and `z`; `multiplication.combine(multiplication.combine(x, y), z)` equals to `multiplication.combine(x, multiplication.combine(y, z))`
