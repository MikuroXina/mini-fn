...
export const partialEq = <A, B>(equality: PartialEq<A>): PartialEq<Const<A, B>> => ({
...
export const partialOrd = <A, B>(order: PartialOrd<A>): PartialOrd<Const<A, B>> => ({
    ...partialEq(order),
...
export const applicative = <M>(monoid: Monoid<M>): Applicative<Apply2Only<ConstHkt, M>> => ({
    ...functor(),
